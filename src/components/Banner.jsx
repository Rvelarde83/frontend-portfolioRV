...
export const Banner = () => {
  ...
  const toRotate = [ "Software Engineer", "Full Stack Developer", "Musician" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Ramon Velarde`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Software Engineer", "Full Stack Developer", "Musician" ]'><span className="wrap">{text}</span></span></h1>
